 ...
 * @return the return code - 0 on success, negative number (< 0) on error.
 */
extern ZIP_EXPORT int zip_entry_extract(struct zip_t *zip, size_t (*on_extract)(void *arg, unsigned long long offset, const void *data, size_t size), void *arg);
 ...
 */
extern ZIP_EXPORT void zip_crc32_func(unsigned long (*crc32_func)(unsigned long crc, const void *buf, size_t bufsize));
