...
struct RegAlloc {
    ...
    void compile_rounding_mode(size_t cur_time, const Operation *op, const REGISTER help_reg, const bool use_rounds = false, const FP_REGISTER in_reg = FP_REG_NONE);
