...
\newcommand{\PraesentationSeitenrand}{12mm}
...
\setbeamertemplate{frametitle}{%
    {%
        \rule{0pt}{42mm + \PraesentationPositionKorrekturOben}%
        \PraesentationSchriftgroesseSehrGross\selectfont\insertframetitle\strut\par%
        {%
          \ifx\insertframesubtitle\empty%
          \else%
          {\PraesentationSchriftgroesseGross\selectfont\insertframesubtitle\newline\strut\par}%
          \fi%
        }%
        %\vspace*{10mm}%
    }%
