...
\newcommand{\ProgramSchemeVersionThree}[2]{
    ...
    \begin{centering}
        \begin{tikzpicture}[very thick, scale=#1]
            ...
            % compiler arrow
            \TikZArrowX{TUMOrange}{12}{-10}{6}{1.5}
            % arrow label
            \node[align=center] at (14.5,-10) (compiler_text) {\fontsize{#2}{#2} \selectfont Compiler};

            % x86_64 rectangle
            %background
            \filldraw[purple] (18,-8) rectangle (22,-12);
            % black border
            \draw[black] (18,-8) rectangle (22,-12);
            % label
