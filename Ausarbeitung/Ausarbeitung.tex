...
This project aims to describe the development of a static binary translator which translates RISC-V binaries to x86\_64
machine code. The current rise of RISC-V processors makes it probable that we will see a need for 
RISC-V to x86\_64 binary translation in the near future. Even though x86\_64
is still a more widely used ISA than RISC-V, a lot of companies invest in a shift towards the
RISC-V ISA.~\cite{riscv_rises} This revolution makes ISA incompatibilities a future problem for which
we are able to present a solution today. 
