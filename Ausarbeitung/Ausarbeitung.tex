...
any variable in the call tree until we reached a variable which ca not be backtracked or until we evaluated
all possible values.
...
This optimization is sometimes also referred to as \textit{Value numbering}~\cite[p.~24]{ssa_proposal}: Each variable is
    ...
    \begin{centering}
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot table[x=benchmark, y expr=\thisrow{test1} /\thisrow{native}] from {./tikz_src/benchmarks_results1.txt};
