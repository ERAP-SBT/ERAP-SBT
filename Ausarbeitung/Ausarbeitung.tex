...
To show an example of the code the naive generator produces the IR shown in \ref{fig:example_ir} is used.
This simple IR which decrements a counter until it's 0 produces the assembly shown in \ref{fig:naive_gen_asm}.
...
To show an example of the generated assembly the same IR as in \ref{fig:example_ir} is used.
The produced assembly will look like in \ref{fig:reg_gen_asm}.
