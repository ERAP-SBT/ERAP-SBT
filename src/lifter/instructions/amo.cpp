...
void load_rs1_to_rd(BasicBlock *bb, RV64Inst &instr, Lifter::reg_map &mapping, uint64_t ip, const Type &op_size) {
...
void store_val_to_rs1(BasicBlock *bb, RV64Inst &instr, Lifter::reg_map &mapping, uint64_t ip, const Type &op_size, SSAVar *value) {
...
void Lifter::lift_amo_load_reserve(BasicBlock *bb, RV64Inst &instr, reg_map &mapping, uint64_t ip, const Type &op_size) { load_rs1_to_rd(bb, instr, mapping, ip, op_size); }

void Lifter::lift_amo_store_conditional(BasicBlock *bb, RV64Inst &instr, reg_map &mapping, uint64_t ip, const Type &op_size) {
...
void Lifter::lift_amo_add(BasicBlock *bb, RV64Inst &instr, reg_map &mapping, uint64_t ip, const Type &op_size) {
...
void Lifter::lift_amo_swap(BasicBlock *bb, RV64Inst &instr, reg_map &mapping, uint64_t ip, const Type &op_size) {
    load_rs1_to_rd(bb, instr, mapping, ip, op_size);
...
void Lifter::lift_amo_xor(BasicBlock *bb, RV64Inst &instr, reg_map &mapping, uint64_t ip, const Type &op_size) {
    load_rs1_to_rd(bb, instr, mapping, ip, op_size);
...
void Lifter::lift_amo_or(BasicBlock *bb, RV64Inst &instr, reg_map &mapping, uint64_t ip, const Type &op_size) {
    load_rs1_to_rd(bb, instr, mapping, ip, op_size);
...
void Lifter::lift_amo_and(BasicBlock *bb, RV64Inst &instr, reg_map &mapping, uint64_t ip, const Type &op_size) {
    load_rs1_to_rd(bb, instr, mapping, ip, op_size);
